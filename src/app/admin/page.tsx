              ...
              <div className="mb-6 rounded-2xl border border-stone-800 bg-stone-900 p-6">
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  <div className="rounded-xl bg-stone-800 p-3 text-center">
                    ...
                    <p className="text-xl font-light text-stone-100">{stats.reduce((s: number, d: any) => s + d.signups, 0)}</p>
                  </div>
                  <div className="rounded-xl bg-stone-800 p-3 text-center">
                    <p className="text-xs text-stone-500 mb-1">Purchases</p>
                    <p className="text-xl font-light text-stone-100">{stats.reduce((s: number, d: any) => s + d.purchases, 0)}</p>
                  </div>
                  <div className="rounded-xl bg-stone-800 p-3 text-center">
                      ...
                      {v.idImageUrl && (
                        <div>
                          ...
                          <a href={v.idImageUrl} target="_blank" rel="noopener noreferrer">
                            <img src={v.idImageUrl} alt="ID" className="rounded-lg object-contain border border-stone-700 hover:border-amber-700 transition-colors max-h-32 max-w-full" />
                          </a>
                        </div>
                      )}
                      {v.videoUrl && (
                        <div>
                          ...
                          <video src={v.videoUrl} controls className="rounded-lg bg-stone-800 max-h-32 max-w-full" />
                        </div>
                      )}
