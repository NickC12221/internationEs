    ...
    <div className="min-h-screen bg-stone-950">
      ...
      <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <h1 className="text-2xl font-light text-stone-100" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif' }}>Premium Listing</h1>
        </div>
        ...
        {isPremium ? (
          <div className="rounded-2xl border border-amber-800/50 bg-amber-950/20 p-8 text-center">
            ...
            <h2 className="text-2xl font-light text-amber-300" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif' }}>You're Premium!</h2>
            <p className="mt-2 text-stone-400">
              Your premium listing is active
              {profile?.premiumExpiresAt && <> until {new Date(profile.premiumExpiresAt).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</>}.
            </p>
          </div>
        ) : (
          <>
            <div className="mb-8 rounded-2xl border border-stone-800 bg-stone-900 p-6">
              <h2 className="mb-4 text-xl font-light text-stone-100" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif' }}>What's Included</h2>
            ...
            <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-amber-700 py-3.5 text-base font-medium text-white hover:bg-amber-600 transition-colors">
